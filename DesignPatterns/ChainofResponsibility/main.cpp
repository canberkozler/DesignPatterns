...
int main() {
...

    {
        ...
        Event an_event;
        an_event.id = 1;
        an_event.message = "Hello there from TEST1.";
...

    {
        ...
        Event an_event;
        an_event.id = 2;
        an_event.message = "Hello there from TEST2.";
        Event returned_event = handleevent1->Handle(an_event);
        std::cout << "returned event id: " << returned_event.id << std::endl;
    }

    {
        ...
        Event an_event;
        an_event.id = 3;
        an_event.message = "Hello there from TEST3.";
        Event returned_event = handleevent1->Handle(an_event);
        std::cout << "returned event id: " << returned_event.id << std::endl;
    }

    {
        ...
        Event an_event;
        an_event.id = 4;
        an_event.message = "Gello there from TEST4.";
        Event returned_event = handleevent1->Handle(an_event);
        std::cout << "returned event id: " << returned_event.id << std::endl;
    }

    delete handleevent1, handleevent2, handleevent3;
}